...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4490DB);
  late Color secondary = const Color(0xFFF29649);
  late Color tertiary = const Color(0xFF9D72CB);
  late Color alternate = const Color(0xFFD36679);
  late Color primaryText = const Color(0xFF35393E);
  late Color secondaryText = const Color(0xFFA5AAB4);
  ...
  late Color customColor1 = Color(0xFF518FFF);
}
